...
export default function AutoCarousel() {
    ...
    return (
        <div
            ...
            className="relative w-full h-screen overflow-hidden bg-gradient-to-br from-zinc-800 to-zinc-900"
        >
            {/* Slides Container */}
            <div className="relative w-full h-full">
                {slides.map((slide, index) => (
                    ...
                    >
                        ...
                        {/* Accent Light */}
                        <div className="absolute top-1/2 left-0 w-[300px] h-[300px] -translate-y-1/2 bg-red-600/20 blur-[80px] pointer-events-none" />

                        {/* Content Grid */}
                        <div className="relative h-full max-w-[1400px] mx-auto px-8 md:px-16 flex items-center">
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 w-full items-center">
                                ...
                                >
                                    ...
                                    <p className="text-sm md:text-base leading-relaxed opacity-80 mb-10 max-w-[500px] mx-auto lg:mx-0">
                                        {slide.description}
                                    </p>
