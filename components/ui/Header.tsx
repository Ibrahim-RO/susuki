                    ...
                    <div className="flex justify-between items-center h-16 md:h-20">
                        ...
                        <div className='hidden md:flex items-center gap-4'>
                            <motion.button
                                ...
                                whileTap={{ scale: 0.95 }}
                                className="px-6 py-2 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-full font-medium shadow-lg hover:shadow-xl transition-shadow"
                            >
                                Manéjalo
                            </motion.button>
                ...
                {isOpen && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="fixed right-0 bottom-0 w-80 bg-white shadow-2xl md:hidden overflow-y-auto z-50"
                            style={{ top: '6.5rem' }}
                        >
                            <div className="p-6 space-y-1">
                                {menuItems.map((item, index) => (
                                    <motion.a
                                        ...
                                        whileTap={{ scale: 0.95 }}
                                        onClick={() => setIsOpen(false)}
                                        className="flex items-center px-4 py-4 text-gray-700 hover:bg-linear-to-r hover:from-blue-50 hover:to-purple-50 hover:text-blue-600 rounded-xl transition-all font-medium text-lg border-b border-gray-100"
                                    >
                                        {item.name}
                                    </motion.a>
                                ))}
                                ...
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.95 }}
                                    className="w-full mt-6 px-6 py-4 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-xl font-semibold shadow-lg text-lg"
                                >
                                    Comenzar
                                </motion.button>
